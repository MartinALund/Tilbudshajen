  ...
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
      ...
      Row(
        ...
        children: <Widget>[
          ShoppingRowItemWidget(
              shoppingItem: new ShoppingItem(
                  title: "Test6",
                  imageUrl:
                      "https://cdn.imgbin.com/4/0/4/imgbin-shark-drawing-cartoon-sharks-blue-and-white-shark-illustration-TcZ3JgGBqMZyqg940QsPRbY8f.jpg",
                  price: "39.95")),
          ShoppingRowItemWidget(
            shoppingItem: new ShoppingItem(
                title: "Test2",
                imageUrl:
                    "https://img.favpng.com/1/22/6/requiem-shark-cartoon-png-favpng-HJCf6ugGmqF03SPi8LkhsT7dK.jpg",
                price: "55"),
          ),
          ShoppingRowItemWidget(
            shoppingItem: new ShoppingItem(
                title: "Test3",
                imageUrl:
                    "https://www.pngitem.com/pimgs/m/292-2923106_transparent-shark-png-transparent-fish-and-shark-cartoon.png",
                price: "75"),
          ),
        ],
      )
